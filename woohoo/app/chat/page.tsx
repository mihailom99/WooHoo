      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {chats.length === 0 ? (
          <div className="text-center max-w-md mx-auto p-8">
            <div className="w-24 h-24 bg-gradient-to-br from-[#5A189A] via-[#8A2BE2] to-[#B666D9] rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <Link
              href="/matches"
              className="bg-gradient-to-r from-[#5A189A] via-[#8A2BE2] to-[#B666D9] text-white font-semibold py-3 px-6 rounded-full hover:from-pink-600 hover:to-red-600 transition-all duration-200"
            >
              Start Swiping
            </Link>
          </div>
